...
let parent = React.createElement("div", {
    ...
    React.createElement("div", {
        id: "child2"
    }, "this is text from child2:")
]);
let root = ReactDOM.createRoot(document.getElementById("root"));
root.render(parent); //! this code is look like a mess and its very difficult to read the code to tackle this issue we have something known as JSX:
